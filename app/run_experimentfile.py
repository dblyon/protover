...
if __name__ == "__main__":
    ...
    parser.add_argument("-fn", "--experiment_file", help="Experiment file, contains all settings of how to run the Protover program",
        type=str, default=r"/data/experiment_file.txt")

    args = parser.parse_args()
    fn = args.experiment_file
